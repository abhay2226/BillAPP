    ...
    try {
        ...
        const referenceTypes = [
...

            {
                ...
                code: "INVDEL",
                description:
                    "Product is deleted or an inventory is deleted"
            },

            {
                ...
                code: "BILCRE",
                description:
                    "Inventory item is a new bill"
            },

            {
                // when bill is deleted each item is given this before adding back the exact qty back to inventory
                code: "BILDEL",
                description:
                    "Stock reduced because of a sale"
            },

            {
                ...
                code: "DAMADD",
                description:
                    "Stock reduced because of damaged goods"
            },
        ...
        for (
            ...
            if (existingReferenceType) {
                ...
                existingReferenceType.is_active =
                    true;

                existingReferenceType.updated_at =
                    new Date();
        ...
        console.log(
            "Reference type seeding completed."
        );
